...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LALT_T(KC_MINS), KC_Z, KC_X, KC_C, KC_V, KC_B, /**/ KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LGUI_T(KC_QUOT),
                 MO(NAV), MO(NUM), LSFT_T(KC_SPC), /**/ LCTL_T(KC_BSPC), MO(SYM), MO(FN)
    ),
...
LALT_T(KC_MINS), KC_Z, KC_X, KC_C, KC_V, KC_B, /**/ KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LGUI_T(KC_QUOT),
             LT(NUM, KC_ESC), KC_LSFT, KC_SPC, /**/ LCTL_T(KC_BSPC), LT(SYM, KC_DQT), MO(FN)
    ),

    [SYM] = LAYOUT(
         KC_AT,   KC_LCBR, KC_LBRC, KC_LPRN, KC_BSLS, /**/ _______, KC_RPRN, KC_RBRC, KC_RCBR, _______,
